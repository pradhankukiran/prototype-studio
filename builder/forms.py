...
class FieldForm(StyledModelForm):
    ...
    def __init__(self, *args, project=None, entity=None, **kwargs):
        ...
        self.fields['calculation_expression'].help_text = 'Example: weekly_hours * hourly_rate'
        self.fields['visibility_condition'].help_text = 'Example: service_type == "Transport"'
        self.fields['validation_expression'].help_text = 'Example: value >= 0 and value <= plan_budget'
        self.fields['validation_message'].help_text = 'Shown when the validation expression returns false.'
