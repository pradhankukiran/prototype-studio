...
from .auth import get_project, get_project_with_prefetch
from .forms import (
    EntityForm,
    FieldForm,
    ProjectForm,
...
def dashboard(request: HttpRequest) -> HttpResponse:
    projects = list(
        PrototypeProject.objects.all().prefetch_related(
...
def project_detail(request: HttpRequest, slug: str) -> HttpResponse:
    project = get_project_with_prefetch(
        request,
        slug,
        prefetch_related=[
            "entities__fields",
...
def entity_detail(request: HttpRequest, slug: str, entity_slug: str) -> HttpResponse:
    project = get_project(request, slug)
